...
if __name__ == "__main__":
    ...
    p = argparse.ArgumentParser()
    p = p.parse_args()
    p.input = "/home/qzj517/POR-DD/Enamine_library/gnina/gnina_full.sdf"
    p.output = "/home/qzj517/POR-DD/GB_GA/runs/all_enamine_lipinski"
